...
public class ProfilesController {
	...
	public ResponseEntity<Boolean> existsById(@PathVariable("ahId") Long ahId){
		return ResponseEntity.ok(ahService.exitsById(ahId));
	}
	
	@PostMapping
	public ResponseEntity<AccountHolder> add(@RequestBody @Valid AccountHolder ah, BindingResult bindingResult) throws AccountHolderException{
